...
const Login = () => {
    ...
    return (
        <>
            <section className="flex flex-col  w-full min-h-screen items-center justify-center bg-green-another">
                ...
                <div className="flex flex-row justify-between  items-center py-4 gap-8 ">
                    {isClient ? (
                        <lottie-player
                            ...
                            loop
                            mode="normal"
                            src="https://lottie.host/805ddb78-d659-415d-8d9f-98555828a259/mJ2DtvbSOa.json"
                    ...
                    <div className="flex flex-col items-center justify-center gap-2">
                        ...
                        <form className=" justify-center items-center flex flex-row gap-6 ">
                            <button type="submit">
                                <Image src="/github.svg" alt="google" width={45} height={45} />
                            </button>
                            <button type="submit">
                                <Image src="/google.svg" alt="google" width={45} height={45} />
                            </button>
                        </form>
                    </div>
                </div>
